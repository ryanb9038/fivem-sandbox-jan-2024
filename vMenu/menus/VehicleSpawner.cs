...
namespace vMenuClient.menus
{
    public class VehicleSpawner
    {
        ...
        private void CreateMenu()
        {
            ...
            var replacePrev = new MenuCheckboxItem("~c~Replace Previous Vehicle", "This will automatically delete your previously spawned vehicle when you spawn a new vehicle.", ReplaceVehicle);
