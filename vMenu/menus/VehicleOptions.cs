...
namespace vMenuClient.menus
{
    public class VehicleOptions
    {
        ...
        private void CreateMenu()
        {
            ...
            var vehGodMenuBtn = new MenuItem("~c~God Mode Options", "Enable or disable specific damage types.") { Label = "→→→" };
            MenuController.AddSubmenu(menu, vehGodMenu);

            // Create Checkboxes.
            var vehicleGod = new MenuCheckboxItem("~c~Vehicle God Mode", "Makes your vehicle not take any damage. Note, you need to go into the god menu options below to select what kind of damage you want to disable.", VehicleGodMode);
            ...
            var vehicleInvisible = new MenuItem("~y~Toggle Vehicle Visibility", "Makes your vehicle visible/invisible. ~r~Your vehicle will be made visible again as soon as you leave the vehicle. Otherwise you would not be able to get back in.");
